...
public final class OnboardingView: UIView, CAAnimationDelegate {
    ...
    public var bottomPageControlViewOffset: CGFloat = UIDevice.current.hasNotch ?
    32 : 10 { didSet { bottomPageControlViewAnchor.constant = -bottomPageControlViewOffset } }
    ...
    fileprivate func preparedPageView(at page: Int) -> PageView {
        ...
        pageView.buttonStart.isHidden = !(page == (pageControlView.pages-1))
